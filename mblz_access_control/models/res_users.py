...
class ResUsers(models.Model):
    ...
    is_mtto_supervisor = fields.Boolean(string='Is mtto supervisor', required=False)
    ...
    def _get_default_field_ids(self):
        return self.env['ir.model.fields'].search([
            ...
            ('name', 'in',
             ('action_id', 'menu_id', 'groups_id', 'hide_menu_ids', 'lang', 'tz', 'flag_crete_tkt_portal',
              'is_mtto_supervisor')),
        ]).ids
    ...
    #             text = f'{r.name} - {r.user_profile_id.name}'
